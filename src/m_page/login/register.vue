<template>
			...
			<el-main class="main">
				<el-input
					placeholder="请输入邮箱"
  					...
  					class="mailbox"
  					v-show="flag"		
            @change="emailVerification"		
  					>
				</el-input>
				<span class="danger" v-show="flag4">邮箱格式不正确</span>
				<p class="danger" v-show="flag7">邮箱已被注册</p>
        <p class="danger" v-show="flag11">邮箱未填</p>
				<el-input v-model='phonenumber' placeholder="请输入手机号" class="input-with-select" v-show="flag1" @change="phoneVerification">
  			...
  			<p class="danger" v-show="flag9">手机未填</p>
        ...
        <p class="danger" v-show="flag10">密码未填</p>
		<br>
  				<el-input
					placeholder="再次输入密码"
  					v-model="repassword"
...
export default {
  ...
  methods: {
    ...
    emailVerification() {
      ...
      if (reg.test(this.email) || this.email.length == 0) {
        this.flag4 = false;
      } else {
        this.flag4 = true;
      }
    ...
    phoneVerification() {
      ...
      if (reg1.test(this.phonenumber) || this.phonenumber.length == 0) {
        this.flag5 = false;
      } else {
        this.flag5 = true;
      }
    ...
    repasswordVerification() {
      if (this.repassword != this.password && this.repassword.length != 0) {
        this.flag3 = true;
      } else {
        this.flag3 = false;
      }
    ...
    finish() {
      if (this.flag1 == true && this.phonenumber.length == 0) {
        this.flag9 = true;
      } else {
        this.flag9 = false;
      }
      if (this.flag1 == true && this.password.length == 0) {
        this.flag10 = true;
      } else {
        this.flag10 = false;
      }
      if (
        (this.flag1 == true && this.repassword.length == 0) ||
      ...
      if (
        ...
        if (this.repassword.length == 0 || this.password != this.repassword) {
          this.flag3 = true;
        } else {
          this.flag3 = false;
        }
